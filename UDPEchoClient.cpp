...
/**
 *    @file
 *          Multi-threaded UDP Echo client application
 */
...
"\n"
"  -c, --send-count=int       Number of packets to send at each send interval.\n"
"                             Defaults to 1.\n"
"  -i, --send-interval=int    Interval between sending, in microseconds.\n"
"                             Defaults to 1000000 (1 second).\n"
"  -l, --local-port=int       Base port number for local ports. Defaults to 50000.\n"
"  -L, --send-limit=int       Maximum number of packets to send.  Defaults to\n"
"                             unlimited.\n"
"  -n, --no-affinity          Disable use of processor affinity.\n"
"  -r, --stats-interval=int   Interval at which send/receive statistics are\n"
"                             reported.  Defaults to 1.  Specify 0 to disable\n"
"                             periodic reporting.\n"
"  -R, --receive-buf-size=int Size of the UDP socket receive buffer, in bytes.\n"
"                             Defaults to system default.\n"
"  -s, --packet-size=int      Size of packet in bytes. Defaults to 20.\n"
"  -S, --send-buf-size=int    Size of the UDP socket send buffer, in bytes.\n"
"                             Defaults to system default.\n"
"  -t, --threads=int          Number of send/receive thread pairs. Defaults to 1.\n"
"  -T, --send-time=int        Amount of time to spend sending packets, in\n"
